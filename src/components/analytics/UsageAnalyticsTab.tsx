...
/** Who is using the hub, and how — as opposed to the Data analytics tab, which is about what clients are saying. */
export async function UsageAnalyticsTab() {
  const {
    eventCount,
    totalEvents,
    firstEvent,
...
/* ── Presentational helpers, kept local to this tab. ─────────────────── */
